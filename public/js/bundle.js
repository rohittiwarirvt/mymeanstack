...
var showAlert = function showAlert(type, msg) {
  var timeout = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
  hideAlert();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged Out succesfully!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoicm9oaXR0aXdhcmlydnQiLCJhIjoiY2tubXgyNnZwMHUwOTJyb3h6cWhkODN1ZiJ9.2Zq2RW3KbDvHiCDsJrElRg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).setMaxWidth('300px').addTo(map); // Extend map bound to include current location
...
var stripe = Stripe('pk_test_51IihbSSGHLKQ0at0t9vupE6vproiyeNOFO9bmHsUWG5dmyS9ozQgm24Xe4kYMPoknjGPnRlCmUFSgdBPMTWZcTrp00Hj8CjQCR');
...
var bookTourBtn = document.getElementById('book-tour'); // maps render
